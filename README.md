...
You can find the list of requirements in [requirements.txt](https://github.com/Vengie1/Hybrid-Deep-Learning-for-Robust-Deepfake-Video-Detection-Integrating-ResNeXt-and-LSTM/requirements.txt). Main requirements are listed below:
...
#### Step 3: All set now launch up your application at [http://localhost:80](http://localhost:80)
